...
class Finding(BaseModel):
    ...
    conflicting_evidence: Optional[List[str]] = Field(None, description="Any conflicting evidence")
    assumptions: Optional[List[str]] = Field(None, description="Assumptions made")
